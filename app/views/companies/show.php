    ...
    <section class="section-box-2">
        <div class="container">
            <div class="banner-hero banner-image-single">
                <img src="<?= asset($company->cover_image ?? 'assets/imgs/page/company/img.png') ?>" alt="<?= $company->name ?>">
            </div>
            <div class="box-company-profile">
                <div class="image-compay">
                    <img src="<?= asset($company->logo) ?>" alt="<?= $company->name ?>" style="min-height: 100px;">
                </div>
                <div class="row mt-10">
                    <div class="col-lg-8 col-md-12">
                        <h5 class="f-18"><?= $company->name ?>
                            <span class="card-location font-regular ml-20"><?= $company->address ?></span>
                        </h5>
                    </div>
                    <div class="col-lg-4 col-md-12 text-lg-end">
                        <a class="btn btn-call-icon btn-apply btn-apply-big" href="page-contact.html">Liên hệ</a>
                    </div>
                </div>
            </div>
            <div class="box-nav-tabs mt-40 mb-5">
                <ul class="nav" role="tablist">
                    <li>
                        <a class="btn btn-border aboutus-icon mr-15 mb-5 active" href="#tab-about" data-bs-toggle="tab" role="tab" aria-controls="tab-about" aria-selected="true">Về chúng tôi</a>
                    </li>
                </ul>
            </div>
                                    ...
                                    <div class="card-grid-2 hover-up">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-2-image-left">
                                                    <div class="image-box">
                                                        <img src="<?= $company->logo ?>" alt="<?= $job->name ?>">
                                                    </div>
                                                    <div class="right-info">
                                                        <a class="name-job" href="/jobs/show?id=<?= $job->id ?>"><?= $company->name ?></a>
                                                        <span class="location-small"><?= $job->address ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <span class="card-time"><?= $job->created_at->diffForHumans() ?>
                                            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                    <div class="sidebar-border">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="sidebar-text-info">
                                        ...
                                        <strong class="small-heading"><?= $company->address ?></strong>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="sidebar-list-job">
                            ...
                            <div class="mt-30">
                                <a class="btn btn-send-message" href="page-contact.html">Gửi tin nhắn</a>
                            </div>
                        </div>
                    </div>
                </div>
