        ...
        <div class="container">
            <div class="row login-register-cover">
                <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
                    ...
                    <form class="login-register text-start mt-20" action="#">
                        <div class="form-group">
                            <label class="form-label" for="input-1">Tên tài khoản hoặc email *</label>
                        ...
                        <div class="text-muted text-center">Chưa có tài khoản? <a href="page-signin.html">Đăng ký</a></div>
                    </form>
                    <div class="mt-20">
                ...
                <div class="img-1 d-none d-lg-block">
                    <img class="shape-1" src="assets/imgs/page/login-register/img-4.svg" alt="JobBox">
                </div>
                <div class="img-2">
